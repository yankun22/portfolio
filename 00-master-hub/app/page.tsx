...
const PROJECTS = [
  ...
  { id: 'agentmesh', numberPrefix: '11', title: 'AgentMesh', category: 'Distributed & AI Systems', stack: ['Next.js 15', 'TypeScript', 'Zustand', 'Canvas 2D'], summary: 'Autonomous multi-agent consensus network & topology simulator featuring 5 archetypes, particle beams, Byzantine quorum loops, and vector buffer inspection.', metrics: '5-Step Quorum Loop', url: 'https://agentmesh.vercel.app' },
  { id: 'voxeldb', numberPrefix: '12', title: 'VoxelDB', category: 'Web3D & Web Audio', stack: ['Three.js', 'React Three Fiber', 'WebGL', 'Zustand'], summary: 'High-density 3D vector space visualizer & HNSW engine with 1,500+ embeddings, dynamic Top-K laser conduits, multi-metric distance solvers, and INT8 quantization HUD.', metrics: '1,500+ WebGL Vectors', url: 'https://voxeldb.vercel.app' },
  { id: 'eventpulse', numberPrefix: '13', title: 'EventPulse', category: 'Distributed & AI Systems', stack: ['Next.js 15', 'Kafka Streams', 'TypeScript', 'Zustand'], summary: 'Enterprise real-time event streaming cockpit with a 3-stage partitioned Kafka/Redpanda pipeline canvas, live schema evolution validator, chaos engine, and DLQ reprocessor.', metrics: '10k events/s Pipeline', url: 'https://eventpulse.vercel.app' },
  { id: 'latencylens', numberPrefix: '14', title: 'LatencyLens', category: 'Distributed & AI Systems', stack: ['Next.js 15', 'D3 Geo', 'SVG Maps', 'Zustand'], summary: 'Global Anycast network routing simulator and microsecond waterfall Gantt profiler comparing Edge V8 Isolates vs OCI container cold starts across 6 worldwide PoPs.', metrics: '0.4ms Cold Start', url: 'https://latencylens.vercel.app' },
  { id: 'promptforge', numberPrefix: '15', title: 'PromptForge', category: 'Distributed & AI Systems', stack: ['Next.js 15', 'TypeScript', 'Tailwind CSS', 'Zustand'], summary: 'Enterprise prompt engineering arena with dual split-pane streaming, 5-case automated LLM guardrail evaluation suite, and semantic token diff & cache cost arbitrage calculator.', metrics: '90% Cache Savings', url: 'https://promptforge.vercel.app' },
];

const CATEGORIES = [
  { label: 'All Deployments (15)', value: 'All' },
  { label: 'Distributed & AI Systems', value: 'Distributed & AI Systems' },
