...
export const COLOR_PALETTES = [
  ...
  { name: 'British Racing Green', hex: '#10b981' },
  { name: 'Liquid Bronze', hex: '#c5a059' },
  ...
  { name: 'Brushed Copper', hex: '#ea580c' },
  { name: 'Terracotta Ochre', hex: '#d97706' },
  { name: 'Smoked Onyx', hex: '#18181b' },
];
...
export const DESIGNER_PRESETS: PresetDesign[] = [
  {
    ...
    config: {
      upper: { material: 'leather', color: '#0b0c0e' },
      ...
      laces: { material: 'leather', color: '#0b0c0e' },
    },
  },
  {
    id: 'champagne-apex',
    name: 'Champagne Gold Apex',
    tagline: 'Warm Champagne Titanium with Smoked Pods',
    badge: 'Most Popular',
    thumbnailColor: '#d4af37',
    config: {
      upper: { material: 'leather', color: '#0b0c0e' },
      sole: { material: 'carbon', color: '#18181b' },
      cushion: { material: 'polycarbonate', color: '#d4af37' },
      cage: { material: 'titanium', color: '#e5c07b' },
      heel: { material: 'carbon', color: '#0b0c0e' },
      laces: { material: 'titanium', color: '#d4af37' },
    },
  },
  {
    id: 'titanium-frost',
    name: 'Liquid Titanium Edition',
    tagline: 'Polished Aerospace Titanium & Platinum Chassis',
    badge: 'Limited Edition',
    thumbnailColor: '#e2e8f0',
    config: {
      upper: { material: 'leather', color: '#1e293b' },
      sole: { material: 'leather', color: '#0f172a' },
      cushion: { material: 'polycarbonate', color: '#e2e8f0' },
      cage: { material: 'titanium', color: '#ffffff' },
      heel: { material: 'carbon', color: '#18181b' },
      laces: { material: 'titanium', color: '#d4af37' },
    },
  },
